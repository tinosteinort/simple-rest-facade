...
class HeaderParamCollector extends AbstractCollector<List<ParameterCacheInfo>> {
	...
	@Override
	public void apply(final MethodCall methodCall, final DefaultMethodInformation methodInformation, final String mediaType, final List<ParameterCacheInfo> headerParameterIndexes) {
